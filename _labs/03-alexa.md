...
First upload the lambda function zip package, you can download the code from [HERE]({{ "/assets/lab3/alexa_skill_lambda_v1.zip"  | relative_url }}), keep the hander as **"lambda_function.lambda_handler"**, then slick **"Save”**
